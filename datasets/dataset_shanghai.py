...
if __name__ == '__main__':
    # 创建训练集、测试集和验证集的实例
    train_dataset = Shanghai('/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/shanghai.h5', 128, type='train')
    test_dataset = Shanghai('/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/shanghai.h5', 128, type='test')
    val_dataset = Shanghai('/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/shanghai.h5', 128, type='val')
