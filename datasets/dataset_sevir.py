...
if __name__ == '__main__':
    ...
    SAVE_PATH = '/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/visualize/sevir/'
    DATA_PATH = '/media/root1/B3D12CBDE981113E/dty/DiffCast-main/datasets/data/sevir'
    with h5py.File('%s/data/vil/2018/SEVIR_VIL_STORMEVENTS_2018_0101_0630.h5' % DATA_PATH,'r') as hf:
    ...
    for i in range(49):
        resized = cv2.resize(vil[:,:,i],(90, 100), interpolation=cv2.INTER_LINEAR)
        print(resized.shape)
        # cv2.imwrite("f'{SAVE_PATH}/{i}.png", resized)
        imageio.imwrite(f'{SAVE_PATH}/{i}.png', resized)
    #     plt.imshow(vil[:9, :, i])
